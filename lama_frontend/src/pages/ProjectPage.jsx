...
import ProjectFileUploadScreen from '../components/ProjectComponents/ProjectFileUploadScreen';
const LeftSidebar = () => {
    ...
    return (
        <div className='flex justify-around'>
             ...
             overflow-y-auto text-center bg-gray-900`}>
                ...
                <div className='flex flex-col gap-4 mt-2'>
                    <div onClick={() => handleTabClick('tab1')
                        ...
                        <button className='h-6 w-6 rounded-full bg-purple-300 mr-2'>1</button>
                        <p>Projects</p>
                    </div>
                    <div onClick={() => handleTabClick('tab2')}
                        ...
                        className='flex w-60 border border-black-700 rounded-full ml-4 py-2 pl-2'>
                        <button className='h-6 w-6 rounded-full bg-purple-300  mr-2'>2</button>
                        <p>Widget Configuration</p>
                    </div>
                    <div
                        className='flex w-60 border border-black-900 rounded-full ml-4 py-2 pl-2'>
                        <button className='h-6 w-6 rounded-full bg-purple-300  mr-2'>3</button>
                        <p>Deployment</p>
                    </div>
                    <div
                        className='flex w-60 border border-black-700 rounded-full ml-4 py-2 pl-2'>
                        <button className='h-6 w-6 rounded-full bg-purple-300  mr-2'>4</button>
                        <p>Pricing</p>
                    </div>
                </div>
                <div className='mt-80'>
                    <hr />
                    <div className='flex w-60 border border-black-700 rounded-full ml-4 py-2 pl-2 mt-6'
                        onClick={() => {
                            handleTabClick('tab5')
                            handleClickSettings()
                        }}
            ...
            <div>
                {showSettings ? <Settings /> : <ProjectFileUploadScreen />}
            </div>
